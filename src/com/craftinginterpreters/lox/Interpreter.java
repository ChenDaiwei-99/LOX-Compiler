...
//        return environment.get(expr.name);
    ...
    public Object visitLogicalExpr(Expr.Logical expr) {
        ...
        if (expr.operator.type == TokenType.OR) {   // check whether we can short-circuit
    ...
    // send the inside expression back into the Interpreter Visitor
    ...
    public Void visitFunctionStmt(Stmt.Function stmt) {
        ...
        // the function declaration should bind the resulting object to a new variable
