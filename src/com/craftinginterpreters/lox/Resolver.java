...
// a variable resolution pass does a single walk over the syntax tree to resolve all the variables it contains
...
public class Resolver implements Expr.Visitor<Void>, Stmt.Visitor<Void> {
    ...
    // since a static analysis does not control flow or short-circuiting, logical
    ...
    public Void visitVariableExpr(Expr.Variable expr) {
        // If the variable exists in the current scope but its value is false, that means we have
        // declared it but not yet defined it. Thus, we can't use this variable here.
    ...
    private void resolveFunction(Stmt.Function function, FunctionType type) {
        FunctionType enclosingFunction = currentFunction;   // stash
    ...
    private void declare(Token name) {
        ...
        // We add the variable to the innermost scope, but not assigned yet.
        // So we use Boolean false to mark it as "not ready yet".
    }
